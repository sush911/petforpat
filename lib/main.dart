...
import 'package:petforpat/features/dashboard/presentation/views/dashboard_home.dart';
import 'package:petforpat/features/dashboard/presentation/views/dashboard_view.dart';
import 'package:petforpat/features/splash/presentation/views/splash_view.dart'; // 👈 Add this
...
class PetForPatApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // Optional: catch any invalid routes
